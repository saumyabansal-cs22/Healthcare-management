        ...
        <div className="mb-4">
          ...
          <div className="space-x-4 md:col-span-2 flex justify-center mt-6">
            <button
              ...
              className="px-5 py-2.5 bg-orange-600 text-white font-bold text-lg rounded-lg cursor-pointer transition-colors duration-300 ease-in-out hover:bg-gray-600 disabled:bg-gray-500 disabled:cursor-not-allowed w-full md:w-auto"
            >
              Register
            </button>
            <button
