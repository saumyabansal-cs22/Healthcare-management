      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="space-x-4 text-center mt-6">
          <button
            ...
            className="py-3 px-4 bg-orange-600 text-white rounded-md font-medium hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
          >
            Register 
            </button>
            <button
